                    ...
                    <div className="grid__column-2-4">
                        <div className="footer">
                            <div className="footer__icon">
                                <Link to="/" className="logo-img" href="/"><img src="images/reviewlogo1.png" alt="Logo Review"/>
                                    <h5 style={{margin: "10px" , textDecoration:"none"}}>Review</h5>
                                </Link>
                ...
                <div className="grid__column-2-4">
                    ...
                    <dl className="footer-list">
                        <dt className="footer-item">
                            <a href="https://www.facebook.com/profile.php?id=100012161655028" className="footer-item__link">
                                <i className="fab fa-facebook"></i>
                                Facebook
                            </a>
                        </dt>
                        <dt className="footer-item">
                            <a href="https://www.instagram.com/_suchamay/" className="footer-item__link">
